const Footer = () => {
  return (
      <footer className="sm:p-6 bg-purple-800">
          <div className="md:flex md:justify-between">
              <div className="mb-6 md:mb-0">
                  <a href="https://flowbite.com/" className="flex items-center">
                      <h1 className='w-full text-3xl font-bold text-white'>PAWA.</h1>
                  </a>
              </div>
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-gray-900 dark:text-gray-400">
                          <li className="mb-4">
                              <a href="" className="hover:underline hover:text-purple-500">Flowbite</a>
                          </li>
                  ...
                  <div>
                      ...
                      <ul className="text-gray-600 dark:text-gray-400">
                          ...
                          <li>
                              <a href="#" className="hover:underline hover:text-purple-500">Terms &amp; Conditions</a>
                          </li>
                      </ul>
                  </div>
              </div>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">PAWA™</a>. All Rights Reserved.
              </span>
